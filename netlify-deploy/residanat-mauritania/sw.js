const CACHE_NAME = 'resihub-mauritania-v29';
...
const URLS_TO_CACHE = [
    ...
    './js/study-tools.js?v=resihub-20260829-2',
    './js/advanced-tools.js?v=resihub-20260829-2',
    './js/vendors/jspdf.umd.min.js',
    '../assets/js/pwa-update.js?v=resihub-20260829-2',
    './manifest.json',
    './favicon.ico',
    './data/lectures.json',
