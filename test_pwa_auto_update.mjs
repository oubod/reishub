...
assert.match(mauritaniaWorker, /resihub-mauritania-v41/);
...
for (const path of mauritaniaPages) {
  assert.match(read(`residanat-mauritania/${path}`), /pwa-update\.js\?v=resihub-20260902-3" data-sw="\.\/sw\.js\?v=resihub-20260902-3"/);
}
