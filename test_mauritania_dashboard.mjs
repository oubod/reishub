...
assert.match(sourceWorker, /resihub-mauritania-v39/, "cache version must refresh returning users");
...
assert.match(source, /css\/mauritania-ui\.css\?v=resihub-20260902-1/);
