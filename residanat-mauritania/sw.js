const CACHE_NAME = 'resihub-mauritania-v44';
...
const URLS_TO_CACHE = [
    ...
    './css/style.css',
    './css/mauritania-ui.css?v=resihub-20260903-3',
    './js/app.js',
    './js/supabase-client.js',
    './js/portal-auth.js?v=8',
    './js/study-tools.js?v=resihub-20260903-3',
    './js/advanced-tools.js?v=resihub-20260903-3',
    './js/ai-pdf.js?v=resihub-20260903-3',
    './js/ai-jobs.js?v=resihub-20260903-3',
    ...
    '../assets/js/pwa-update.js?v=resihub-20260903-3',
    './manifest.json',
    './favicon.ico',
    './data/lectures.json',
